...
public class SurroundedRegionCorrectAns {

	public static void main(String[] args) {
		//char[][] board = {{'X','X','X','X'},{'X','O','O','X'},{'X','X','O','X'},{'X','O','X','X'}};		
		//char[][] board = {{'X','X','X','X'},{'X','X','X','X'},{'X','X','O','X'},{'X','O','X','X'}};		
		char[][] board = {{'X','X','X','X'},{'X','X','X','X'},{'X','X','O','X'},{'X','O','O','X'}};		
		//char[][] board = {{'X','X','X','X'},{'X','O','O','X'},{'X','X','O','X'},{'X','O','X','X'}};		
	    ...
	    // Depth First Search (DFS) to mark connected 'O' cells as visited
	    public static void dfs(char[][] board, int r, int c, boolean[][] vis) {
